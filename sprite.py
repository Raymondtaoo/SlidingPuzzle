...
class Tile(pygame.sprite.Sprite):
    def __init__(self, game, x, y, text, image, original_pos):
    ...
    def update(self):
        ...
        if self.text != "empty":
        # Use original position to determine which part of the image to draw
            orig_x, orig_y = self.original_pos
            self.image.blit(self.game.image_tiles[orig_y][orig_x], (0, 0))
